...
![WF2](out/assets/Menu.svg)

### **`WF3`** Детализация блюда

![alt text](out/assets/Dish_detail.svg)

### **`WF4`** Корзина без авторизации в ЛК

![alt text](out/assets/Сart_without_autorisation.svg)

### **`WF5`** Авторизация/регистраиция

![alt text](out/assets/Autorisation_registration.svg)

### **`WF6`** Аутентификация

![alt text](out/assets/Autentification.svg)

### **`WF7`** Корзина после авторизации в ЛК

![alt text](out/assets/Сart_with_autorisation.svg)

### **`WF8`** Выбор заказа с собой или в зале

![alt text](out/assets/Packing.svg)

### **`WF9`** Выбор варианта оплаты

![alt text](out/assets/Payment_options.svg)

### **`WF10`** Оплата картой

![alt text](out/assets/Payment_bankcard.svg)

### **`WF11`** Оплата наличными

![alt text](out/assets/Payment_cash.svg)

### **`WF12`** Оплата СБП

![alt text](out/assets/Payment_SBP.svg)

### **`WF13`** Уведомление об оплате

![alt text](out/assets/Payment_notification.svg)

### **`WF14`** Сообщение с ожиданием действий от пользователя

![alt text](out/assets/Waiting_action.svg)
