...
Представлены диаграммы последовательности сервиса авторизации и сервисов описывающих взаимодействие в рамках процесса получения заказа и передачи его на кухню
